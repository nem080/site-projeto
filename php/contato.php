<?php
 $vnomeC = $_POST["nomeContato"];
 $vsobreC = $_POST["sobreNomeContado"];
 $vemailC = $_POST["emailContato"];
...
$cmdInsert = "INSERT INTO usuarios (nome, sobrenome, cep, cidade, estado, bairro, logadouro, numero, complemento)
